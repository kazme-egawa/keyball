...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_universal(
    ...
    KC_LALT  , KC_LGUI  , KC_SPC   , KC_SPC   , KC_SPC   , MO(_UTIL), KC_SPC   ,              KC_ENT , KC_DEL   , _______  , _______  , _______  , KC_GRV   , KC_BSLS 
  ),
  ...
  [_AUTO_MOUSE] = LAYOUT_universal(
    ...
    KC_LALT  , KC_LGUI  , KC_SPC   , KC_SPC   , KC_SPC   , MO(_UTIL), KC_SPC   ,              KC_ENT , KC_DEL   , _______  , _______  , _______  , KC_GRV   , SCRL_MO
  ),
  ...
  [_UTIL] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_F1    , KC_F2    , KC_F3    , KC_F4    , KC_F5    , _______  ,            _______  , _______  , KC_BTN4  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_BTN5  ,
    KC_LALT  , KC_LGUI  , KC_SPC   , KC_SPC   , KC_SPC   , _______  , KC_SPC   ,            KC_ENT   , KC_DEL   , _______  , _______  , _______  , _______  , _______
  ),
